...
function App() {
  ...
  // state values
  const [payload, setUserPayload] = useState({})
    ...
    <React.Fragment>
      ...
      <div style={styles.containerStyle}>
        <section style = {{backgroundImage:"url("+"data:image/jpeg;base64,"+")"}} >
          <h1 align='center' style={{color: 'gold'}}  >Sawo Login Form </h1>
          {/* Showing Successful login message */}
          {isLoggedIn && (
            <React.Fragment>
              <div style={styles.loggedin}>
              <h2>User Successfully logged In.</h2>
              <p>Welcome!, This is just a Dashboard created after the login page of Sawo for DaeDarus Hackathon.</p>
                <div>UserId: {payload.user_id}</div>
                <p style={{color:"orange" , fontFamily:"opensans"}}> Now here are the links for some following sites:-   </p>
                <p style={{color:"orange" , fontFamily:"opensans"}}>https://daedarus-hack.devpost.com/</p>
                <p style={{color:"orange" , fontFamily:"opensans"}}>https://sawolabs.com/</p>
                <p style={{color:"orange" , fontFamily:"opensans"}}>https://github.com/Miyanboy</p>
